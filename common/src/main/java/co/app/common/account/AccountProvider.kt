...
object AccountProvider {
    @Provides
    @JvmStatic
    fun bindAccount(readAccount: UserAccount.ReadAccount): UserAccount = readAccount
...
object AccountModule {
    ...
    fun provideWriteAccount(preferences: Preferences,
                            promise: AndroidPromise, gson: Gson): UserAccount = UserAccount.WriteAccount(preferences, promise, gson)
